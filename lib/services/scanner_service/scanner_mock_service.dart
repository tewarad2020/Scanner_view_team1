...
class ScannerMockService implements ScannerServiceInterface {
  List<Product> allProduct = [
    Product(name: 'ช้างเล็ก ยกลัง', nickname: 'ช้างยังไม่โต', skuId: '1', barcode: '8851993613102', amount: 1, price: 100, remainInStock: 2),
    Product(name: 'ช้างใหญ๋ แพค6', nickname: 'ช้างโตแล้ว', skuId: '2', barcode: '1234567891234', amount: 2, price: 400, remainInStock: 4),
    Product(name: 'เอสโคล่า ขวดลิตร ยกลัง', nickname: 'ทำไมไม่กินโค้ก', skuId: '3', barcode: '9938131085162', amount: 1, price: 250, remainInStock: 10),
    Product(name: 'ยำยำช้างน้อย ยกลัง', nickname: 'ไม่เคยเอามาต้มกิน', skuId: '4', barcode: '4643975201987', amount: 9, price: 100, remainInStock: 15),
    Product(name: 'น้ำเปล่าMinere ขวดเล็ก', nickname: 'น้ำช้างเท่านั้นครับ', skuId: '5', barcode: '2756879808465', amount: 12, price: 7, remainInStock: 15),
  ];
